...
export const trainingPrograms: Record<SessionKey, TrainingProgram> = {
  ...
  flexibility: {
    ...
    exercises: [
      { nameKey: 'exercise_arm_circles', instructionKey: 'instruction_arm_circles', safetyKey: 'safety_arm_circles', levels: [{ key: 'duration_seconds', params: { count: 45 } }, { key: 'duration_minutes', params: { count: 1 } }, { key: 'duration_minutes', params: { count: 1.5 } }], illustrationUrl: '/images/arm_circles.png', rpeZone: [2, 4] },
      { nameKey: 'exercise_hamstring_stretch', instructionKey: 'instruction_hamstring_stretch', safetyKey: 'safety_hamstring_stretch', levels: [{ key: 'duration_seconds_per_leg', params: { count: 20 } }, { key: 'duration_seconds_per_leg', params: { count: 30 } }, { key: 'duration_seconds_per_leg', params: { count: 45 } }], illustrationUrl: '/images/hamstring_stretch.png', rpeZone: [2, 4] },
      { nameKey: 'exercise_calf_stretch', instructionKey: 'instruction_calf_stretch', safetyKey: 'safety_calf_stretch', levels: [{ key: 'duration_seconds_per_leg', params: { count: 20 } }, { key: 'duration_seconds_per_leg', params: { count: 30 } }, { key: 'duration_seconds_per_leg', params: { count: 45 } }], illustrationUrl: '/images/calf_stretch.png', rpeZone: [2, 4] },
      { nameKey: 'exercise_shoulder_stretch', instructionKey: 'instruction_shoulder_stretch', safetyKey: 'safety_shoulder_stretch', levels: [{ key: 'duration_seconds_per_arm', params: { count: 20 } }, { key: 'duration_seconds_per_arm', params: { count: 30 } }, { key: 'duration_seconds_per_arm', params: { count: 45 } }], illustrationUrl: '/images/shoulder_stretch.png', rpeZone: [2, 4] },
      { nameKey: 'exercise_chest_stretch', instructionKey: 'instruction_chest_stretch', safetyKey: 'safety_chest_stretch', levels: [{ key: 'duration_seconds', params: { count: 20 } }, { key: 'duration_seconds', params: { count: 30 } }, { key: 'duration_seconds', params: { count: 45 } }], illustrationUrl: '/images/chest_stretch.png', rpeZone: [2, 4] },
    ],
  },
  cardio: {
    ...
    exercises: [
      ...
      { nameKey: 'exercise_seated_rowing', instructionKey: 'instruction_seated_rowing', safetyKey: 'safety_seated_rowing', levels: [{ key: 'duration_minutes', params: { count: 2 } }, { key: 'duration_minutes', params: { count: 3 } }, { key: 'duration_minutes', params: { count: 4 } }], illustrationUrl: '/images/seated_rowing.png', rpeZone: [4, 6] },
    ],
  },
  posture: {
    titleKey: 'session_type_posture',
    exercises: [
      { nameKey: 'exercise_wall_push_ups', instructionKey: 'instruction_wall_push_ups', safetyKey: 'safety_wall_push_ups', levels: [{ key: 'duration_reps_sets', params: { count: 8, sets: 2 } }, { key: 'duration_reps_sets', params: { count: 10, sets: 2 } }, { key: 'duration_reps_sets', params: { count: 12, sets: 3 } }], illustrationUrl: '/images/wall_push_ups.png', rpeZone: [4, 6] },
      { nameKey: 'exercise_cat_cow_stretch', instructionKey: 'instruction_cat_cow_stretch', safetyKey: 'safety_cat_cow_stretch', levels: [{ key: 'duration_reps', params: { count: 10 } }, { key: 'duration_reps', params: { count: 12 } }, { key: 'duration_reps', params: { count: 15 } }], illustrationUrl: '/images/cat_cow_stretch.png', rpeZone: [2, 4] },
